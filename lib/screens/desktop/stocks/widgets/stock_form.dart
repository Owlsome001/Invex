    ...
    return Card(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomFormFied(fieldName: "Catégorie", field: CustomDropDown(choices: stocksController.categories, defaultChoice: 0, onTap: (value){},)),
          CustomFormFied(fieldName: "Unité de mésure", field: CustomDropDown(choices: stocksController.units, defaultChoice: 0, onTap: (value){},)),
